...
- Modify `src/doctor_patient_dialogue/config/agents.yaml` to define your agents
- Modify `src/doctor_patient_dialogue/config/tasks.yaml` to define your tasks
- Modify `src/doctor_patient_dialogue/crew.py` to add your own logic, tools and specific args
- Modify `src/doctor_patient_dialogue/main.py` to add custom inputs for your agents and tasks
...
This command initializes the doctor_patient_dialogue Crew, assembling the agents and assigning them tasks as defined in your configuration.
...
For support, questions, or feedback regarding the DoctorPatientDialogue Crew or crewAI.
